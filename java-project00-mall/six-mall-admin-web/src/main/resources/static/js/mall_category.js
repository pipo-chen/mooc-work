$(function () {
    var categoryLevel = getQueryVariable("categoryLevel");
...
function categoryManage() {
    var categoryLevel = parseInt(getQueryVariable("categoryLevel"));
    var parentId = getQueryVariable("parentId");
    ...
    if (categoryLevel == 1 || categoryLevel == 2) {
        ...
        window.location.href = 'mall_category.html?categoryLevel=' + categoryLevel + '&parentId=' + id + '&backParentId=' + parentId;
    } else {
        swal("无下级分类", {
            icon: "warning",
        });
...
function categoryBack() {
    var categoryLevel = parseInt(getQueryVariable("categoryLevel"));
    var backParentId = getQueryVariable("backParentId");
    if (categoryLevel == 2 || categoryLevel == 3) {
        categoryLevel = categoryLevel - 1;
        window.location.href = 'mall_category.html?categoryLevel=' + categoryLevel + '&parentId=' + backParentId + '&backParentId=0';
    } else {
        swal("无上级分类", {
            icon: "warning",
        });
