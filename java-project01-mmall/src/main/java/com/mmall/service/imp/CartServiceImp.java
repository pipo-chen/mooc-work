...
public class CartServiceImp implements ICartService {
	...
	public ServerResponse<CartVo> selectOrUnselectAll(Integer userId, Integer checked) {
		cartMapper.checkOrUnCheckedProduct(null, userId, checked);
		return this.list(userId);
	}

	@Override
	public ServerResponse<CartVo> selectOrUnselectProduct(Integer userId, Integer checked, Integer productId) {
		cartMapper.checkOrUnCheckedProduct(productId, userId, checked);
		return this.list(userId);
	}
	...
	public ServerResponse<Integer> getCartProductCount(Integer userId) {
		...
		return ServerResponse.createBySuccess(cartMapper.selectCardProductCount(userId));
	}
}
